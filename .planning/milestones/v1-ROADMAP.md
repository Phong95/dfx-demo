...
- [x] **Phase 3: AI-Assisted Cleanup via MCP** - Claude Desktop connects over MCP to inspect the loaded drawing, propose cleanup operations from natural-language intent, and apply them only after a preview/dry-run confirmation. (completed 2026-08-24)
...
| 3. AI-Assisted Cleanup via MCP | 2/2 | Complete    | 2026-08-24 |
</content>
